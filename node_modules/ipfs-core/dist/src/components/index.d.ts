...
declare class IPFS {
    ...
    block: BlockAPI;
    refs: ((ipfsPath: any, options?: any) => AsyncIterable<import("ipfs-core-types/src/refs").RefsResult>) & {
    ...
    dht: {
        ...
        findProvs: (cid: any, options?: any) => AsyncIterable<import("ipfs-core-types/src/dht").PeerResult>;
        findPeer: (peerId: string, options?: any) => Promise<import("ipfs-core-types/src/dht").PeerResult>;
        provide: (cid: any, options?: any) => AsyncIterable<import("ipfs-core-types/src/dht").DHTQueryMessage>;
    ...
    get: (ipfsPath: any, options?: any) => AsyncIterable<import("ipfs-core-types/src/root").IPFSEntry>;
    ls: (ipfsPath: any, options?: any) => AsyncIterable<import("ipfs-core-types/src/root").IPFSEntry>;
    dag: DagAPI;
...
declare namespace IPFS {
    export { Options, Print, StorageAPI, BlockCodec };
}
