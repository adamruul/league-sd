...
declare class ObjectAPI {
    ...
    data: (multihash: any, options?: any) => Promise<Uint8Array>;
    get: (cid: any, options?: any) => Promise<import("@ipld/dag-pb/src/interface").PBNode>;
    links: (cid: any, options?: any) => Promise<import("@ipld/dag-pb/src/interface").PBLink[]>;
    new: (options?: any) => Promise<any>;
    put: (obj: import("@ipld/dag-pb/src/interface").PBNode, options?: any) => Promise<any>;
    stat: (cid: any, options?: any) => Promise<import("ipfs-core-types/src/object").StatResult>;
