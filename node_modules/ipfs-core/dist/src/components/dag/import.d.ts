declare function _exports({ repo }: {
    repo: IPFSRepo;
}): (sources: AsyncIterable<AsyncIterable<Uint8Array>> | Iterable<AsyncIterable<Uint8Array>>, options?: any) => AsyncIterable<import("ipfs-core-types/src/dag/").ImportResult>;
export = _exports;
