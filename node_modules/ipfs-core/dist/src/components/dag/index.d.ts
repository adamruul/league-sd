...
declare class DagAPI {
    ...
    import: (sources: AsyncIterable<AsyncIterable<Uint8Array>> | Iterable<AsyncIterable<Uint8Array>>, options?: any) => AsyncIterable<import("ipfs-core-types/src/dag").ImportResult>;
    resolve: (ipfsPath: any, options?: any) => Promise<import("ipfs-core-types/src/dag").ResolveResult>;
