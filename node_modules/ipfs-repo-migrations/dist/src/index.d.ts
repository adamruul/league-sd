 ...
 */
export function migrate(path: string, backends: import('./types').Backends, repoOptions: import('./types').RepoOptions, toVersion: number, { ignoreLock, onProgress, isDryRun, migrations }?: {
 ...
 */
export function revert(path: string, backends: import('./types').Backends, repoOptions: import('./types').RepoOptions, toVersion: number, { ignoreLock, onProgress, isDryRun, migrations }?: {
    onProgress?: import("./types").ProgressCallback | undefined;
    isDryRun?: boolean | undefined;
    ignoreLock?: boolean | undefined;
    migrations?: import("./types").Migration[] | undefined;
